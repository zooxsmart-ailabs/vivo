      ...
      >
        ...
        <div style="position: relative">
          ...
          <input
            ...
            "
            @focus="
              ($event.target as HTMLInputElement).style.borderColor = '#660099';
              ($event.target as HTMLInputElement).style.boxShadow =
                '0 0 0 3px rgba(102,0,153,0.1)';
              ($event.target as HTMLInputElement).style.background = '#fff';
            "
            @blur="
              ($event.target as HTMLInputElement).style.borderColor =
                'rgba(0,0,0,0.1)';
              ($event.target as HTMLInputElement).style.boxShadow = 'none';
              ($event.target as HTMLInputElement).style.background = '#F2F2F7';
            "
          />
        </div>
        ...
        <button
          ...
          :style="{
            ...
            padding: '13px',
            background:
              loading || !username || !password ? '#C7A3D9' : '#660099',
            color: 'white',
            border: 'none',
            borderRadius: '12px',
            fontSize: '15px',
