...
export const video = pgTable("video", {
  ...
  // Video Metrics
  valVideoTimeToStart: integer("val_video_time_to_start"),
  attrVideoInitialBufferingTime: integer("attr_video_initial_buffering_time"),
  attrVideoRebufferingCount: integer("attr_video_rebuffering_count"),
  valVideoRebufferingTime: integer("val_video_rebuffering_time"),
  isVideoFailsToStart: boolean("is_video_fails_to_start"),
  valVideoQualityTime144p: integer("val_video_quality_time_144p"),
  valVideoQualityTime240p: integer("val_video_quality_time_240p"),
  valVideoQualityTime360p: integer("val_video_quality_time_360p"),
  valVideoQualityTime480p: integer("val_video_quality_time_480p"),
  valVideoQualityTime720p: integer("val_video_quality_time_720p"),
  valVideoQualityTime1080p: integer("val_video_quality_time_1080p"),
  valVideoQualityTime1440p: integer("val_video_quality_time_1440p"),
  valVideoQualityTime2160p: integer("val_video_quality_time_2160p"),
  attrVideoResolution: varchar("attr_video_resolution", { length: 5 }),
  isVideoResolutionSwitchHappened: boolean(
    "is_video_resolution_switch_happened"
  ),
  isVideoInStreamFailure: boolean("is_video_in_stream_failure"),
  ...
  isCellServiceDcnrRestricted: boolean("is_cell_service_dcnr_restricted"),
  isCellServiceEndcAvailable: boolean("is_cell_service_endc_available"),
