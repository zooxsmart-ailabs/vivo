-- =============================================================================
-- Migration 0008: Add has_vivo_data flag to vw_geohash_summary
--
-- Problem: Cells where only competitors have QoE data appear in the view
--   with vivo_score=0, quadrant=GROWTH_RETENCAO, indistinguishable from
--   cells where Vivo genuinely has poor metrics.
--
-- Fix: Add has_vivo_data boolean that is TRUE only when Vivo has real
--   measurement samples (score_pivot.vivo_score IS NOT NULL before COALESCE).
-- =============================================================================
