...
|----|-----------|------|-----|-----|--------------|-----|
| T01 | Exibir ranking de geohashes por estrategia | SE | 10 | 3 | Medio | 5 |
| T02 | Filtrar geohashes por busca de bairro | CE | 3 | 1 | Simples | 3 |
| T03 | Ordenar lista por campo selecionado | CE | 2 | 1 | Simples | 3 |
| T04 | Calcular KPIs da frente (clientes, share, satisfacao) | SE | 6 | 2 | Medio | 5 |
