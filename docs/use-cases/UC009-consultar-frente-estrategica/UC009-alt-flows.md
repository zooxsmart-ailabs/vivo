...
## FA01 — Frente GROWTH_RETENCAO (Expansao) {#fa01}

**Condicao de Desvio:** A frente GROWTH_RETENCAO nao aparece como aba, mas sim como painel complementar quando um geohash GROWTH_RETENCAO e selecionado via mapa (UC001/UC004).

| Passo | Ator | Acao / Resposta do Sistema |
|-------|------|----------------------------|
| 1 | Sistema | Detecta que geohash selecionado e GROWTH_RETENCAO |
