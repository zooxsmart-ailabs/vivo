...
|-------|------|----------------------------|
| 1 | Sistema | Seção Camada 2 é omitida do painel de detalhamento |
...
**Condição de Desvio:** A busca por nome de bairro não retorna resultados.

| Passo | Ator | Ação / Resposta do Sistema |
|-------|------|----------------------------|
| 1 | Sistema | Lista mostra "Nenhum bairro encontrado" |
| 2 | Sistema | Painel de detalhamento mantém último bairro exibido |
