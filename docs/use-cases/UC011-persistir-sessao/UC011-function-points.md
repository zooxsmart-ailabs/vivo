...
|----|------|------|-----|-----|--------------|-----|
| D01 | user_session | ALI | 12 | 3 | Médio | 10 |
...
|----|-----------|------|-----|-----|--------------|-----|
| T01 | Serializar estado em SessionState | SE | 12 | 3 | Médio | 5 |
| T02 | Persistir em Redis (write) | EE | 12 | 1 | Médio | 4 |
| T03 | Persistir em PostgreSQL (upsert) | EE | 12 | 1 | Médio | 4 |
| T04 | Restaurar de Redis (read) | CE | 12 | 1 | Médio | 4 |
| T05 | Restaurar de PostgreSQL (fallback) | CE | 12 | 1 | Médio | 4 |
