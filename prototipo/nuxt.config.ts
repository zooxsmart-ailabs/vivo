...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      ...
      link: [
        { rel: "icon", type: "image/x-icon", href: "/vivo/favicon.ico?v=3" },
        { rel: "shortcut icon", type: "image/x-icon", href: "/vivo/favicon.ico?v=3" },
        { rel: "icon", type: "image/png", href: "/vivo/favicon.png?v=3" },
        {
          rel: "stylesheet",
